# Contributing to PyWebScrapr

Thank you for considering contributing to **PyWebScrapr**! Contributions, whether they are bug fixes, new features, or improvements to the documentation, are always welcome. Before contributing, please read the following guidelines to ensure smooth collaboration.
...
1. **Report Issues**  
   Use the [GitHub Issues page](https://github.com/Infinitode/PyWebScrapr/issues) to report bugs or suggest features. Please include:
...
3. **Follow Licensing Requirements**  
   Ensure that any derivative works comply with the [license](https://github.com/infinitode/PyWebScrapr/blob/main/LICENSE).

By contributing, you agree to abide by these guidelines and this project's [license](https://github.com/infinitode/PyWebScrapr/blob/main/LICENSE). Thank you for helping make **PyWebScrapr** better!